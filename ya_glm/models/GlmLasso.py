...
from ya_glm.make_docs import merge_param_docs, set_docs
...
class GlmLasso(LossMixin, PenGlm):
...
class GlmLassoCV(GlmCVSinglePen):
...
class GlmENet(LossMixin, PenGlm):
    ...
    _pen_descr = dedent("""
        ...
        where Lasso(coef) is either the Lasso, group Lasso penalty, multi-task lasso or nuclear norm.
        """)

    _params_descr = merge_param_docs(LossMixin._params_descr, _enet_params, PenGlm._params_descr)
